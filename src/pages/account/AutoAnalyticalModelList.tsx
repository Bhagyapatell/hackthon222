...
export default function AutoAnalyticalModelList() {
    ...
    const { data, error } = await supabase
      ...
      .select(`
        *,
        ...
        partner:contacts!auto_analytical_models_partner_id_fkey(name),
        product:products!auto_analytical_models_product_id_fkey(name),
        product_category:product_categories!auto_analytical_models_product_category_id_fkey(name),
        partner_tag:tags!auto_analytical_models_partner_tag_id_fkey(name, color)
      `)
  ...
  const columns = [
    ...
    },
    {
      ...
      label: 'Status',
      render: (value: unknown) => {
        const isArchived = value as boolean;
        return isArchived ? (
